...
//	Nếu không phải thì in ra text "Ngư�?i này không phải là Developer"
		System.out
				.println(account1.position.name == "Dev" ? "�?ây là Developer" : "Ngư�?i này không phải là Developer");
...
//	In ra thông tin các account bao gồm: Email, FullName và tên phòng ban của h�?
		...
		for (Account account : accounts) // account chỉ là biến để tạo vòng lặp (vd như i ở các thí dụ khác) không cần
											// là biến đã được declare ở trên
		{
